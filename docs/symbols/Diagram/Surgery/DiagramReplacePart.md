...
<code>[DiagramReplacePart]()[$d$, $position$ -> $new$]</code> replaces the subdiagram of $d$ at $position$ with $new$.

<code>[DiagramReplacePart]()[$d$, {$pos_1$ -> $new_1$, $pos_2$ -> $new_2$, …}]</code> replaces at several positions.
