...
<code>[DiagramsPortGraph]()[{$d_1$, …}]</code> returns the port graph of the list of diagrams — a graph whose vertices are individual ports and whose edges are the matchings between dual ports.
