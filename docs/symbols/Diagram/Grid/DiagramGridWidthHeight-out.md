...
<code>[DiagramGridWidthHeight](https://resources.wolframcloud.com/PacletRepository/resources/Wolfram/DiagrammaticComputation/ref/DiagramGridWidthHeight)[$d$]</code> gives <code>{width, height}</code> of the diagram's grid layout in one call.
...
![output](images/DiagramGridWidthHeight-out-1.png)
