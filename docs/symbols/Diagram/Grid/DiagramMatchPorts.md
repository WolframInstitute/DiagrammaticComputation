...
<code>[DiagramMatchPorts]()[$d$]</code> aligns the ports of adjacent subdiagrams in a grid layout so that matching ports line up vertically.

## Details & Options

- A grid-layout helper used by <code>[DiagramGrid]()</code> to decide how wires are drawn between adjacent cells. Useful directly when constructing custom layouts.
