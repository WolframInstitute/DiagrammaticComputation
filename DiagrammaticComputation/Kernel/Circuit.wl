BeginPackage["Wolfram`DiagrammaticComputation`Circuit`", {"Wolfram`DiagrammaticComputation`Port`", "Wolfram`DiagrammaticComputation`Diagram`"}];

DiagramsToCircuitDiagram

Begin["Wolfram`DiagrammaticComputation`Circuit`Private`"];
